    ...
    if model_type == 'PT':
        ...
        if model_order == 1:
            ...
            table = [
                ...
                ["",   "T_V",   two_decimal_places(kuhn_fast1[5]), two_decimal_places(kuhn_normal1[5]), two_decimal_places(kuhn_fast2[5]), two_decimal_places(kuhn_normal2[5]), two_decimal_places(lat_10[5]), two_decimal_places(lat_20[5])]
            ]
            ...
            table1 = [
                ...
                ["",   "T_V",   two_decimal_places(kuhn_fast1[5]), two_decimal_places(kuhn_normal1[5]), two_decimal_places(kuhn_fast2[5]), two_decimal_places(kuhn_normal2[5]), two_decimal_places(betrag[5]), two_decimal_places(chr_20[5]), two_decimal_places(chr_ap[5]), two_decimal_places(latzel[5]), two_decimal_places(oppelt[5]), two_decimal_places(samal[5]), two_decimal_places(zini[5]), two_decimal_places(lat_10[5]), two_decimal_places(lat_20[5])]
            ]
            ...
            table2 = [
                ...
                ["",   "T_V",   two_decimal_places(betrag[5]), two_decimal_places(chr_20[5]), two_decimal_places(chr_ap[5]), two_decimal_places(latzel[5]), two_decimal_places(oppelt[5]), two_decimal_places(samal[5]), two_decimal_places(zini[5])]
            ]
        ...
        K_S = characteristic_values[0]
        T_u = characteristic_values[1]
        T_g = characteristic_values[2]
